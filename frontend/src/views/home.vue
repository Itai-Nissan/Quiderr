  ...
  <section class="home-body">
    ...
    >
      <div class="heros">
        <div
          class="andrea"
          :class="{ visible: imgIdx === 0 }"
        />
        <div
          class="ritika"
          :class="{ visible: imgIdx === 1 }"
        />
        <div
          class="zach"
          :class="{ visible: imgIdx === 2 }"
        />
        <div
          class="gabrielle"
          :class="{ visible: imgIdx === 3 }"
        />
        <div
          class="moon"
          :class="{ visible: imgIdx === 4 }"
        />
      </div>

      <div class="home-text-and-input">
        <h1 class="home-hero-text">
          Find the perfect <span class="fancy-text">freelance</span> services for your business
        </h1>
        <span class="home-filter-container">
          <img
            class="search-image"
            src="../assets/imgs/icons8-search-30.png"
            alt="search"
          >
          <input
            v-model="searchInput"
        ...
        <div class="popular-tags">
          Popular:
          <div
            class="home-popular-btn"
            @click="search('website design')"
          >
            Website Design
          </div>
          <div
            class="home-popular-btn"
            @click="search('wordpress')"
          >
            WordPress
          </div>
          <div
            class="home-popular-btn"
            @click="search('logo design')"
          >
            Logo Design
          </div>
          <div
            class="home-popular-btn"
            @click="search('nft art')"
          >
            NFT Art
          </div>
        </div>
        ...
        <div class="creator-name">
          <div :class="{ visible: imgIdx === 0 }">
            Andrea, <span>Fashion Designer</span>
          </div>
          <div :class="{ visible: imgIdx === 1 }">
            Ritika, <span>Shoemaker and Designer</span>
          </div>
          <div :class="{ visible: imgIdx === 2 }">
            Zach, <span>Bar Owner</span>
          </div>
          <div :class="{ visible: imgIdx === 3 }">
            Gabrielle, <span>Video Editor</span>
          </div>
          <div :class="{ visible: imgIdx === 4 }">
