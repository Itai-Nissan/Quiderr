          ...
          <section>
            <div class="purchase-info">
              <div class="delivery-wrapper">
                <span class="XQskgrQ delivery-icon" aria-hidden="true"><svg
width="16" height="16" viewBox="0 0 16 16"
              ...
              <div class="revisions-wrapper">
                <span class="XQskgrQ revisions-icon" aria-hidden="true"><svg
viewBox="0 0 16 16"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
      ...
      <div class="purchase-col">
        <section class="purchase-container">
          <div class="purchase-wrapper">
            ...
            <div>
              <button class="purchase-btn" :gig="gig" @click="onSetCreateOrder">
                Purchase
              </button>
            </div>
          </div>
