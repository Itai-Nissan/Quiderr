  ...
  <section v-if="gig && seller" class="details-reviews-pack">
    ...
    <div class="reviews-container">
        ...
        <section class="reviews-bar">
          ...
          <div class="bar">
            ...
            <div class="progress-bar">
              ...
              <span class="front" style="width: 97%"> </span>
            </div>
          ...
          <div class="bar">
            ...
            <div class="progress-bar">
              <span class="back"></span>
              <!-- <span class="front" :style="{ width: getWidth(rate.counter) }"> -->
              <span class="front" style="width: 78%"> </span>
            </div>
          ...
          <div class="bar">
            ...
            <div class="progress-bar">
              <span class="back"></span>
              <!-- <span class="front" :style="{ width: getWidth(rate.counter) }"> -->
              <span class="front" style="width: 20%"> </span>
            </div>
          ...
          <div class="bar">
            ...
            <div class="progress-bar">
              <span class="back"></span>
              <!-- <span class="front" :style="{ width: getWidth(rate.counter) }"> -->
              <span class="front" style="width: 0%"> </span>
            </div>
      ...
      <section class="reviews-list">
        <div
          v-for="review in gig.owner.reviews"
          :key="review.by._id"
