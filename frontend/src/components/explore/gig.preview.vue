<template>
  <section class="gig-preview-container flex space-between" @click="showGigDetails">
    <li>
          ...
          <div class="price-like-wrapper">
            <div class="price-like-container">
              <div :class="{
                ...
                <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" @click="onSetLike">
                  <path
      ...
      <div class="gig-preview-btns flex column space-between" />
    </li>
  </section>
</template>
